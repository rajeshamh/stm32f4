...
void 	USART_Init(USART_Handle_t *pUSARTHandle)
{
	...
	/******************************** Configuration of CR1******************************************/
		...
		USART_Peripheral_ClockControl(pUSARTHandle->pUSARTx,ENABLE);
		...
		if ( pUSARTHandle->USART_Pinconfig.USART_Parity_control == USART_PARITY_EN_EVEN)
		{
		...
		}else if (pUSARTHandle->USART_Pinconfig.USART_Parity_control == USART_PARITY_EN_ODD )
		{
			//Implement the code to enable the parity control
		    tempreg |= ( 1 << USART_CR1_PCE);
	...
	/******************************** Configuration of CR2******************************************/
		...
		tempreg |= pUSARTHandle->USART_Pinconfig.USART_Stop_Bit << USART_CR2_STOP;
	...
	/******************************** Configuration of CR3******************************************/
		...
		if ( pUSARTHandle->USART_Pinconfig.USART_HardwareFlowControl== USART_HW_FLOW_CTRL_CTS)
		{
			//Implement the code to enable CTS flow control
			tempreg |= ( 1 << USART_CR3_CTSE);


		}else if (pUSARTHandle->USART_Pinconfig.USART_HardwareFlowControl == USART_HW_FLOW_CTRL_RTS)
		{
			//Implement the code to enable RTS flow control
			tempreg |= ( 1 << USART_CR3_RTSE);

		}else if (pUSARTHandle->USART_Pinconfig.USART_HardwareFlowControl == USART_HW_FLOW_CTRL_CTS_RTS)
		{
	...
	/******************************** Configuration of BRR(Baudrate register)******************************************/
		...
		USART_SetBaudRate(pUSARTHandle->pUSARTx,pUSARTHandle->USART_Pinconfig.USART_BRR);
...
void    USART_Peripheral_ClockControl(USART_Regdef_t *pUSARTx,uint8_t EnorDi)
{
   ...
   //Loop over until "Len" number of bytes are transferred
	for(uint32_t i = 0 ; i < Len; i++)
	{
		...
		if(pUSARTHandle->USART_Pinconfig.USART_WordLength == USART_WORDLEN_9BITS)
		{
			...
			if(pUSARTHandle->USART_Pinconfig.USART_Parity_control == USART_PARITY_DISABLE)
			{
...
void USART_IRQPriorityConfig(uint8_t IRQNumber,uint8_t Priority)
{
	...
	*(NVIC_IPR_BASEADDR+iprx)|=(Priority<<shift_section);//(NVIC_IPR_BASEADDR+iprx) is a pointer arithmetic operation performed to move
}
...
//Note : CTS feature is not applicable for UART4 and UART5
	...
	uint8_t temp3 = pUSARTHandle->pUSARTx->CR3 & ( 1 << USART_CR3_CTSIE);
